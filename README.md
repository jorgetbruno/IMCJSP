# Calculo de IMC
Este é um pequeno trabalho para a materia de Desenvolvimento de Software para a Web de 2017/1.
O objetivo é calcular o indice de massa corporal de uma pessoa utilizando JSF

## Obtendo o projeto

`git clone https://github.com/jorgetbruno/IMC.git`
